---
title: "How to Write CRM Emails That Get Replies"
description: "Practical tips for writing CRM emails that get replies, from subject lines and personalisation to timing, length, and calls to action."
publishDate: "2026-03-08"
author: "jonny-rowse"
category: "communication"
tags: ["email", "communication", "client engagement"]
featured: false
draft: false
faqs:
  - question: "How long should a CRM email be to get a reply?"
    answer: "Between 50 and 125 words tends to produce the highest response rates. Shorter emails are easier to read and respond to on mobile devices. If you need to share detailed information, keep the email brief and attach a document or link to a page with the full details."
  - question: "What is the best time to send CRM emails?"
    answer: "For UK small businesses, mid-morning on Tuesday to Thursday consistently performs well. Avoid Monday mornings when inboxes are overloaded, and Friday afternoons when people have mentally switched off. Test different times with your own audience, as every client base is slightly different."
  - question: "Should I use my CRM to send bulk emails or individual ones?"
    answer: "It depends on the purpose. For personalised follow-ups, one-to-one emails from your CRM are far more effective. For newsletters or announcements, use your CRM's bulk email or a connected email marketing tool. The key is that sales and relationship emails should always feel individual, even if they are part of a sequence."
primaryKeyword: "CRM emails that get replies"
---
...
<svg viewBox="0 0 600 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Bar chart showing email open rates by subject line type: personalised with name 42%, question-based 38%, specific benefit 35%, generic check-in 18%, no subject 12%">
  <style>
    .chart-title { font: bold 15px Inter, system-ui, sans-serif; fill: currentColor; }
    .chart-label { font: 13px Inter, system-ui, sans-serif; fill: currentColor; }
    .chart-value { font: bold 13px Inter, system-ui, sans-serif; fill: currentColor; }
    .bar-1 { fill: #6366f1; }
    .bar-2 { fill: #818cf8; }
    .bar-3 { fill: #a5b4fc; }
    .bar-4 { fill: #d1d5db; }
  ...
  <text x="300" y="25" text-anchor="middle" class="chart-title">Email Open Rates by Subject Line Type</text>
  <text x="220" y="65" text-anchor="end" class="chart-label">Personalised (name)</text>
  <rect x="230" y="50" width="252" height="28" rx="4" class="bar-1"/>
  <text x="490" y="69" class="chart-value">42%</text>
  <text x="220" y="110" text-anchor="end" class="chart-label">Question-based</text>
  <rect x="230" y="95" width="228" height="28" rx="4" class="bar-2"/>
  <text x="466" y="114" class="chart-value">38%</text>
  <text x="220" y="155" text-anchor="end" class="chart-label">Specific benefit</text>
  <rect x="230" y="140" width="210" height="28" rx="4" class="bar-3"/>
  <text x="448" y="159" class="chart-value">35%</text>
  <text x="220" y="200" text-anchor="end" class="chart-label">Generic check-in</text>
  <rect x="230" y="185" width="108" height="28" rx="4" class="bar-4"/>
  <text x="346" y="204" class="chart-value">18%</text>
  <text x="220" y="245" text-anchor="end" class="chart-label">No subject</text>
  <rect x="230" y="230" width="72" height="28" rx="4" class="bar-5"/>
  <text x="310" y="249" class="chart-value">12%</text>
  <text x="300" y="290" text-anchor="middle" class="chart-label">Source: Aggregate small business email data, 2025</text>
</svg>
...
Your CRM's [automated follow-up sequences](/client-retention/automated-follow-ups-that-feel-personal) can handle the timing for you. Set the intervals, write the emails, and let the system send them at the optimal moment.
...
Build follow-up sequences into your [email workflow](/marketing-automation/email-sequences-every-small-business-should-set-up). A well-timed second email is not annoying; it is professional.
...
If you are already [writing proposals that close deals](/communication/writing-client-proposals-that-close-deals), apply the same principles to your emails: be specific, be relevant, and make it easy for the reader to say yes. Your response rates will follow.
